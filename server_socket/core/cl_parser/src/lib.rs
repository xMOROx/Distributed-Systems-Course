...
mod tests {
    ...
    fn should_panic_when_argument_is_negative() {
        let args = vec!["file".to_string(), "address".to_string(), "8080".to_string(),"-1".to_string()].into_iter();
        Config::build(args);
    }
    ...
    fn should_panic_when_threads_number_argument_is_not_a_number() {
        let args = vec!["file".to_string(), "address".to_string(), "8080".to_string(),"test".to_string()].into_iter();
        Config::build(args);
    }
    ...
    fn should_panic_when_port_number_argument_is_not_a_number() {
        let args = vec!["file".to_string(), "address".to_string(), "port".to_string(),"test".to_string()].into_iter();
        Config::build(args);
    }
    ...
    fn should_panic_when_port_number_is_not_in_range() {
        let args = vec!["file".to_string(), "address".to_string(), "1023".to_string(),"test".to_string()].into_iter();
        Config::build(args);
    }

    #[test]
    fn is_config_with_default_number_of_threads() {
        let args = vec!["file".to_string(), "address".to_string(), "8080".to_string()].into_iter();
    ...
    fn is_config_with_custom_number_of_threads() {
        let args = vec!["file".to_string(), "address".to_string(), "8080".to_string(), "10".to_string()].into_iter();
        let config = Config::build(args);
        assert_eq!(config.get_number_of_threads(), 10_usize);
    }
}
