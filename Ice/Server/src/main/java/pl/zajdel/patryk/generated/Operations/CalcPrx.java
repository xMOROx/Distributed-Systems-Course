...
{
    default long add(double a, double b)
    {
        return add(a, b, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default long add(double a, double b, java.util.Map<String, String> context)
    {
        return _iceI_addAsync(a, b, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Long> addAsync(double a, double b)
    {
        return _iceI_addAsync(a, b, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Long> addAsync(double a, double b, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Long> _iceI_addAsync(double iceP_a, double iceP_b, java.util.Map<String, String> context, boolean sync)
    {
    ...
    default long subtract(double a, double b)
    {
        return subtract(a, b, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default long subtract(double a, double b, java.util.Map<String, String> context)
    {
        return _iceI_subtractAsync(a, b, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Long> subtractAsync(double a, double b)
    {
        return _iceI_subtractAsync(a, b, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Long> subtractAsync(double a, double b, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Long> _iceI_subtractAsync(double iceP_a, double iceP_b, java.util.Map<String, String> context, boolean sync)
    {
    ...
    default long multiply(double a, double b)
    {
        return multiply(a, b, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default long multiply(double a, double b, java.util.Map<String, String> context)
    {
        return _iceI_multiplyAsync(a, b, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Long> multiplyAsync(double a, double b)
    {
        return _iceI_multiplyAsync(a, b, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Long> multiplyAsync(double a, double b, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Long> _iceI_multiplyAsync(double iceP_a, double iceP_b, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Long> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "multiply", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeDouble(iceP_a);
                     ostr.writeDouble(iceP_b);
                 }, istr -> {
    ...
    default long divide(double a, double b)
        throws DivisionByZero
    {
        return divide(a, b, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default long divide(double a, double b, java.util.Map<String, String> context)
        throws DivisionByZero
    {
        try
        {
            return _iceI_divideAsync(a, b, context, true).waitForResponseOrUserEx();
        }
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Long> divideAsync(double a, double b)
    {
        return _iceI_divideAsync(a, b, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Long> divideAsync(double a, double b, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Long> _iceI_divideAsync(double iceP_a, double iceP_b, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Long> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "divide", com.zeroc.Ice.OperationMode.Idempotent, sync, _iceE_divide);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeDouble(iceP_a);
                     ostr.writeDouble(iceP_b);
                 }, istr -> {
    ...
    default long averageSalary(Person[] persons)
    {
        return averageSalary(persons, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default long averageSalary(Person[] persons, java.util.Map<String, String> context)
    {
        return _iceI_averageSalaryAsync(persons, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Long> averageSalaryAsync(Person[] persons)
    {
        return _iceI_averageSalaryAsync(persons, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Long> averageSalaryAsync(Person[] persons, java.util.Map<String, String> context)
    {
        return _iceI_averageSalaryAsync(persons, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Long> _iceI_averageSalaryAsync(Person[] iceP_persons, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Long> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "averageSalary", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
        f.invoke(true, context, null, ostr -> {
